...
class PayPal
{
	...
	var $APIUsername = 'rohit_api1.aprogift.com';
	var $APIPassword = 'KQ67RSE2DZQ6XBXA';
	var $APISignature = 'AiPC9BjkCyDFQXbSkoZcgqH3hpacA6UJTP4kGiR.1gFTwYPCKfnP1lyr';
	var $APISubject = '';
	var $APIVersion = '95.0';
	var $APIButtonSource = '';
	var $APIMode = 'Sandbox';
	var $EndPointURL = 'api.sandbox.paypal.com';
	var $Sandbox = 'TRUE';
	var $BetaSandbox = '';
...
App::import('Vendor', 'Paypal.PayPal_PayFlow');
App::import('Vendor', 'Paypal.PayPal_Adaptive');
