...
class Paypal_Config {
	 ...
	 */
	public $sandbox = TRUE;
	public $domain = 'http://www.aprogift.com';
	
	/**
	 * API Credentials
	 */
	public $api_version = '95.0';
	public $developer_account_email = 'rohit@aprogift.com';		// This is what you use to sign in to http://developer.paypal.com.  Only required for Adaptive Payments.
	...
	public $api_username = 'rohit_api1.aprogift.com';
	public $api_password = 'KQ67RSE2DZQ6XBXA';
	public $api_signature = 'AiPC9BjkCyDFQXbSkoZcgqH3hpacA6UJTP4kGiR.1gFTwYPCKfnP1lyr';
	...
	public function Paypal_Config() {
		...
		$this->domain = $this->sandbox ? 'http://localhost:8080/' : 'http://www.aprogift.com/';
		...
		$this->api_username = $this->sandbox ? 'rohit_api1.aprogift.com' : 'LIVE_API_USERNAME';
		$this->api_password = $this->sandbox ? 'KQ67RSE2DZQ6XBXA' : 'LIVE_API_PASSWORD';
		$this->api_signature = $this->sandbox ? 'AiPC9BjkCyDFQXbSkoZcgqH3hpacA6UJTP4kGiR.1gFTwYPCKfnP1lyr' : 'LIVE_API_SIGNATURE';
