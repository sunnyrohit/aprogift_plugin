...
?>
	...
	function z_bindFriendList() {
		...
		$button.off("click");
        if (canInviteCount == 0) {
			$button.on("click", function() {addPerson('0','0','0');});
			return;
		}
		$button.fSelector({
          max:canInviteCount,
   ...
   function getUserInfo() {
    ...
    // END  facebook stuff added by shikhar//////////    
        ...
        var canInviteCount = <?php echo $thisGroupUser['canInviteCount']; ?>;
                        ...
                        <tr id="row<?php echo $person['id']; ?>">
                            ...
                            <?php
                                ...
                                if ($person['paid'] == 1) {
                                    ...
                                    if ($person['invitee_id'] != 0 && $person['invitee_id'] == $thisGroupUser['id']) {
                                        echo "<input id='delete{$person['id']}' type='checkbox' name='delete{$person['id']}' onchange='javascript: darkenRow({$person['id']})' />";
                                    }
                                }
                            ?>
                            </td>
