...
<?php
    ...
    echo "<h4> GiftBox for ".ucfirst($recipientName)."</h4>";
	echo "<div id='go-back-container'><a class='btn btn-info' href='Invitee?{$_SERVER['QUERY_STRING']}'><i class='icon-arrow-left icon-white'> </i> Go Back</a></div>";
